  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-white text-black hover:bg-white/90 rounded-[10px] h-[49px] px-4 font-normal text-base shadow-[0_4px_20px_rgba(0,0,0,0.4)]",
        "hero-secondary": "bg-black text-white hover:bg-black/90 rounded-[10px] h-[49px] px-4 font-normal text-base",
        glass: "bg-background/80 backdrop-blur-md border border-border rounded-full hover:bg-secondary transition-all",
      },
      size: {
